...
// Signierung: android/keystore.properties (nicht im Git!) wird gelesen, falls vorhanden.
// Siehe README -> "Release-APK signieren".
...
android {
    namespace = "cc.netwokx.ffsms"
    compileSdk = 34

    defaultConfig {
        applicationId = "cc.netwokx.ffsms"
        minSdk = 26
        targetSdk = 34
        versionCode = 1
        versionName = "1.0.0"
